                    ...
                    <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                        <div class="widget am-cf">
                            <div class="widget-head am-cf">
                                <div class="widget-title  am-cf">qtlref</div>


                            </div>
                            <div class="widget-body  am-fr">

                                <form class="am-form tpl-form-border-form tpl-form-border-br" modelAttribute="markerPosition" method="post" action="${ctxroot}/markerposition/saveadd">
                                    ...
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            <input type="text" id="chr" name="chr" class="am-form-field tpl-form-no-bg" placeholder="" >
                                            <small></small>
                                        </div>
                                    </div>
                                    <div class="am-form-group">
                                    ...
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            <textarea type="text" id="version" name="version" class="am-form-field tpl-form-no-bg" placeholder="" ></textarea>
                                            <small></small>
                                        </div>
                                    </div>
                                    ...
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            <input type="text" id="startPos" name="startPos" class="am-form-field tpl-form-no-bg" placeholder="请输入数字" >
                                            <small></small>
                                        </div>
                                    </div>
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            <input type="text" id="endPos" name="endPos" class="am-form-field tpl-form-no-bg" placeholder="请输入数字" >
                                            <small></small>
                                        </div>
                                    </div>
