                    ...
                    <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                        <div class="widget am-cf">
                            ...
                            <div class="widget-body  am-fr">
                                ...
                                <div class="am-btn-group am-btn-group-xs">
                                    <a href="${ctxroot}/static/example/chrlg_example.csv">
                                        <button type="button" class="am-btn am-btn-default am-btn-success"> 导入Chrlg样例文件
                                        </button>
                                    </a>
                                </div>
                                ...
                                <div class="am-u-sm-12">
                                    <table width="100%" class="am-table am-table-striped am-table-bordered am-table-compact" id="example-r">
                                        ...
                                        <tbody>
                                        <c:forEach items="${chrlg}" var="item">
                                            <tr>
                                                <td>${item.id}</td>
                                                <td>${item.chr}</td>
                                                <td>${item.lg}</td>
                                                ...
                                                <td>
                                                    <div class="tpl-table-black-operation">
                                                        <a href="${ctxroot}/chrlg/toedit?id=${item.id}">
                                                            <i class="am-icon-pencil"></i> 编辑
                                                        </a>
                                                        <a href="javascript:;" class="tpl-table-black-operation-del btn-refuse"
                                                           data-src="${ctxroot}/chrlg/delete?id=${item.id}">
...
//                    data:JSON.stringify(sendData),
                ...
                success: function (data) {
                    layer.msg(data);
                    window.location.href = "${ctxroot}/chrlg/list";
                }
            });
        }, function () {
