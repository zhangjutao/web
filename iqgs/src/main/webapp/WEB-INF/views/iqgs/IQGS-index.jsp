        ...
        <div class=" tabs" style="margin-bottom:18px;">
            ...
            <div id="myTabContent" class="tab-content">
                <div id="GeneIdName" class="tab-pane tab-pane-ac" style="margin-left:20px;">
                    ...
                    <label>
                        <input class="search-input" id="key_name" type="text" name="search" onkeyup="value=value.replace(/[^\w\.\,\、\;\s\-/]/ig,'')"  maxlength="255"  placeholder="输入您要查找的关键字">
                ...
                <div id="GeneFunction" class="tab-pane" style="margin-left:20px;">
                    ...
                    <label>
                        <input id="key_func" class="search-input" type="text" name="search" onkeyup="value=value.replace(/[^\w\.\,\、\;\s\-/]/ig,'')"  maxlength="255" placeholder="输入您要查找的关键字">
                        <span class="clear-input" style="display: none"><img src="${ctxStatic}/images/clear-search.png"></span>
