                    ...
                    <div class="box-shadow resulting">
                        <div class="item-header">
                            <div class="icon-left">
                                ...
                                <span style="display: none;">搜索条件: <span class="js-search-desc"></span></span>
                                <i>></i>
                            </div>
                            <div class="icon-right" style="display: none;">
                                <p class="page-num-tab-snp">共<span class="total-page-count-snp">0</span>条结果</p>
                                <p class="page-num-tab-indel">共<span class="total-page-count-indel">0</span>条结果</p>
                            </div>
                        </div>
                        <div class="tab-item">
                            <ul class="item">
                            ...
                            <div class="tab">
                                <div class="tab-txt tab-txt-ac js-snp-tab">
                                    <div id="mask-test">
                                        <div class="genes-tab tab-txt-snps" style="height: auto;min-height:auto;">
                                ...
                                <div class="tab-txt js-indel-tab">
                                    <div id="mask-test2">
                                        <div class="tab-txt-indels genes-tab" style="height: auto;min-height:auto;">
