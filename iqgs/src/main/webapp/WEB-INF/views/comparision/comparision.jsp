                ...
                <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                    <div class="widget am-cf">
                        <div class="widget-head am-cf">
                            <div class="widget-title  am-cf">差异基因数据导入</div>
                        </div>
                                    ...
                                    <div class="am-btn-toolbar">
                                        <div class="am-btn-group am-btn-group-xs">
                                            <a href="javascript:void(0);">
                                                <button type="button" class="am-btn am-btn-default am-btn-success js-upload-modal" ><span class="am-icon-plus"></span> 新建</button>
                                            </a>
                                        </div>
                                            <div class="am-btn-group am-btn-group-xs">
                                                <a href="${ctxroot}/static/example/mrna/SRP017638.zip">
                                                    <button type="button" class="am-btn am-btn-default am-btn-success"> 导入差异基因样例文件
                                                    </button>
                                                </a>
                                            </div>
                                    </div>
        ...
        $('#example-r').DataTable(
                {
                    ...
                    "sAjaxSource": "${ctxroot}/comparision/index",//通过ajax实现分页的url路径。
                    "columns": [
                        {"data": "id"},
                        {'data': 'name'},
    ...
    $("body").on("click", ".js-delete-modal", function() {
        ...
        $('#my-confirm').modal({
            ...
            onConfirm: function(options) {
                $.ajax({
                    url: "${ctxroot}/comparision/delete",
                    data: {id: id},
                    type: "GET",
                    dataType: "json",
                    success: function(data) {
