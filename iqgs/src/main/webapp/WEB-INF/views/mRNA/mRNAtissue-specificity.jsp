        ...
        <div class="tissue-specificity-charts">
            ...
            <div class="tissue-specificity-chartstab">
                <div class="genes-search">
                    ...
                    <button class="btn js-search-gene-btn" type="button"><img src="${ctxStatic}/images/search.png">搜索
                    </button>
                </div>
                <div class="genes-result">
                    ...
                    <div class="genes-result-mid">
                        <p class="genes-result-chooseAll">
                            <button type="button" class="btn-fill js-choose-gene-all"><span> > </span>全部选中</button>
                        </p>
                        <p class="genes-result-clearAll">
                            <button type="button" class="btn-fill js-remove-gene-all"><span> < </span>全部清除</button>
                        </p>
                    </div>
                    <div class="genes-result-right js-choose-gene-result">
                    </div>
                    <div class="genes-result-confirm">
                        <button type="button" class="btn js-specific-gene">确定</button>
                    </div>
                </div>
                    ...
                    <div class="che-list js-checkbox-list">
                        ...
                        <div class="set-genes-tab">
                            <div class="have-chosen">
                                <label class="have-chosen-num">(已选择基因<span
                                        class="js-2nd-choose-text">0/5</span>)</label>
