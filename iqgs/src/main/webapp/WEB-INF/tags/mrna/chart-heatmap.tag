                    ...
                    $.ajax({
                        ...
                        success: function (res) {
                            if (res.gens.length == 0) {
                                $('#heatmap_').empty().html("<div class='explain-b' style='text-align: center;width:1140px; padding-top: 160px;'><img src='${ctxStatic}/images/nodata.png'><div style='padding-top: 10px;position: relative;left: -20px;'>系統异常</div></div>");
                            } else {
