...
public interface RegularityNetworkDao {
     ...
     */
    List<RegularityLink> findRelateGene(@Param("geneId") String geneId, @Param("hierarchy") int hierarchy);
     ...
     * @return 返回该层级上应该返回的所有调控网络基因
     */
    List<RegularityLink> findReverseRelateGene(@Param("geneId") String geneId, @Param("hierarchy") int hierarchy);
}
