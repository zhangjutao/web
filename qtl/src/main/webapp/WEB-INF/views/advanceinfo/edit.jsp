                    ...
                    <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                        <div class="widget am-cf">
                            ...
                            <div class="widget-body  am-fr">
                                ...
                                <form class="am-form tpl-form-border-form tpl-form-border-br" modelAttribute="advanceInfo" method="post" action="${ctxroot}/advanceinfo/saveedit">
                                    <div class="am-form-group" style="display:none">
                                        <label for="" class="am-u-sm-3 am-form-label"> <span class="tpl-form-line-small-title">id</span></label>
                                        <div class="am-u-sm-9">
                                            <input type="text" id="id" name="id" value="${advanceInfo.id}" class="am-form-field tpl-form-no-bg" placeholder="" >
                                            <small></small>
                                        </div>
                                    </div>
                                    ...
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            <input type="text" id="qtlName" name="qtlName" value="${advanceInfo.qtlName}" class="am-form-field tpl-form-no-bg" placeholder="" >
                                            <small></small>
                                        </div>
                                    </div>
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            <textarea type="text" id="plantTraitOntology" name="plantTraitOntology" class="am-form-field tpl-form-no-bg" placeholder="" >${advanceInfo.plantTraitOntology}</textarea>
                                            <small></small>
                                        </div>
                                    </div>
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            <textarea type="text" id="plantOntology" name="plantOntology" class="am-form-field tpl-form-no-bg" placeholder="" >${advanceInfo.plantOntology}</textarea>
                                            <small></small>
                                        </div>
                                    </div>
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            <textarea type="text" id="geneOntology" name="geneOntology" class="am-form-field tpl-form-no-bg" placeholder="" >${advanceInfo.geneOntology}</textarea>
                                            <small></small>
                                        </div>
                                    </div>
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            <textarea type="text" id="otherRelatedQtls" name="otherRelatedQtls" class="am-form-field tpl-form-no-bg" placeholder="" >${advanceInfo.otherRelatedQtls}</textarea>
                                            <small></small>
                                        </div>
                                    </div>
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            <textarea type="text" id="otherNamesQtl" name="otherNamesQtl" class="am-form-field tpl-form-no-bg" placeholder="" >${advanceInfo.otherNamesQtl}</textarea>
                                            <small></small>
                                        </div>
                                    </div>
