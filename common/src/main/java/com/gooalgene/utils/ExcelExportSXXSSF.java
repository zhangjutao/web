...
public class ExcelExportSXXSSF {
	...
	public static void main(String[] args) throws Exception {
		...
		ExcelExportSXXSSF excelExportSXXSSF = ExcelExportSXXSSF.start(filePath, "/wjy/", filePrefix, fieldNames, fieldCodes, flushRows);
		
		//准备导出的数据，将数据存入list，且list中对象的字段名称必须是刚才传入ExcelExportSXXSSF的名称
		List<User> list = new ArrayList<User>();

		User ypxx1 = new User("胡药","123");
		User ypxx2 = new User("骁儿","343");
		list.add(ypxx1);
		list.add(ypxx2);
