...
public class ComparisionController {
    ...
    Logger logger = LoggerFactory.getLogger(ComparisionController.class);
    ...
    public String index(Model model) {
        return "comparision/comparision";
    }
    ...
    public Map<String, Object> list(HttpServletRequest request, Model model, HttpServletResponse response) {
        ...
        List<String> all = mongoService.queryCollectionsByType(0);
        ...
        for (int i = 0; i < count; i++) {
            String sraStudy = query.get(i).replace("Comparison_", "");
    ...
    public String delete(HttpServletRequest request) {
        ...
        if (StringUtils.isNotBlank(id)) {
            String collection = "Comparison_" + id;
        ...
        result.put("mes", mes);
        logger.info("delete:Comparison_" + id + " with result:" + result);
