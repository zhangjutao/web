                ...
                if(count == 0){
                    ...
                    for (var i=0;i<totalDatas.length;i++){
                        ...
                        if(status == 1){
                            ...
                            var str=" <tr myid="+totalDatas[i].id+"><td><p class='notOverflow'>"+totalDatas[i].username+"</p></td><td><p class='notOverflow'>"+totalDatas[i].email+"</p></td><td><p class='notOverflow'>"+domains+"</p></td><td><p class='notOverflow'>"+university+"</p></td><td><p class='notOverflow'>待审核</p></td><td><p class='notOverflow'>"+totalDatas[i].enableDay+"</p></td><td><p class=\'btnAudit btnCommon\'>未审核</p></td></tr>";
                        }
                        console.log(status);
