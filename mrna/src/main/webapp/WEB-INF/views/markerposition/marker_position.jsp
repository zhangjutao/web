                    ...
                    <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                        <div class="widget am-cf">
                            <div class="widget-head am-cf">
                                <div class="widget-title  am-cf">marker_position</div>
                            ...
                            <div class="widget-body  am-fr">
                                    ...
                                    <div class="am-form-group">
                                        <div class="am-btn-toolbar">
                                            <div class="am-btn-group am-btn-group-xs">
                                                <a href="${ctxroot}/markerposition/toadd">
                                ...
                                <div class="am-btn-group am-btn-group-xs">
                                    <a href="${ctxroot}/static/example/marker_position_example.csv">
                                        <button type="button" class="am-btn am-btn-default am-btn-success"> 导入MarkerPosition样例文件
                                        </button>
                                    </a>
                                </div>
                                <div class="am-u-sm-12">
                                    <table width="100%" class="am-table am-table-striped am-table-bordered am-table-compact" id="example-r">
                                        ...
                                        <tbody>
                                        <%--<c:forEach items="${markerposition}" var="item">--%>
                                            <%--<tr>--%>
                                                <%--<td>${item.id}</td>--%>
                                                ...
                                                <%--<td>--%>
                                                    <%--<div class="tpl-table-black-operation">--%>
                                                        <%--<a href="${ctxroot}/markerposition/toedit?id=${item.id}">--%>
                                                            <%--<i class="am-icon-pencil"></i> 编辑--%>
                                                        <%--</a>--%>
                                                        <%--<a href="javascript:;" class="tpl-table-black-operation-del btn-refuse"--%>
                                                           <%--data-src="${ctxroot}/markerposition/delete?id=${item.id}">--%>
    ...
    $(function(){
        $('#example-r').DataTable({
            "scrollX": true,
                    ...
                    "sAjaxSource": "${ctxroot}/markerposition/index",//通过ajax实现分页的url路径。
                    "columns": [
                        {"data": "id"},
                        {'data': 'markerName'},
                        {'data': 'chr'},
                        ...
                        {'data': 'endPos'},
                        {
                            render: function (data, type, row) {
                                return "<div class='tpl-table-black-operation'><a href='${ctxroot}/markerposition/toedit?id=" + row.id + "'><i class='am-icon-pencil'></i> 编辑</a>" + "<a class='tpl-table-black-operation-del del-btn' href='javascript:void(0);' data-id='" + row.id + "'><i class='am-icon-trash'></i> 删除</a></div>";
                            }
                        }
                    ],
                    "bAutoWidth": true, //自适应宽度
...
//                    data:JSON.stringify(sendData),
                ...
                success: function (data) {
                    layer.msg(data);
                    window.location.href = "${ctxroot}/markerposition/list";
                }
            });
        }, function () {
    ...
    $("body").on("click", ".del-btn", function() {
        ...
        $('#my-confirm').modal({
            ...
            onConfirm: function(options) {
                // 删除
                $.ajax({
                    url: "${ctxroot}/markerposition/delete",
                    data: {id: id},
                    type:"GET",
                    dataType: "text",
                    success: function(data) {
