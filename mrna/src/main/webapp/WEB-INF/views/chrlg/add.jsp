                    ...
                    <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                        <div class="widget am-cf">
                            ...
                            <div class="widget-body  am-fr">
                                ...
                                <form class="am-form tpl-form-border-form tpl-form-border-br" modelAttribute="chrlg" method="post" action="${ctxroot}/chrlg/saveadd">
                                    ...
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            <input type="text" id="lg" name="lg" class="am-form-field tpl-form-no-bg" placeholder="" >
                                            <small></small>
                                        </div>
                                    </div>
                                    <div class="am-form-group">
                                    ...
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            <input type="text" id="bps" name="bps" class="am-form-field tpl-form-no-bg" placeholder="请输入物理距离总长度（碱基个数）" >
                                            <small></small>
                                        </div>
                                    </div>
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            <input type="text" id="cMs" name="cMs" class="am-form-field tpl-form-no-bg" placeholder="请输入遗传距离总长度（cMs）" >
                                            <small></small>
                                        </div>
                                    </div>
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            <input type="text" id="cmBp" name="cmBp" class="am-form-field tpl-form-no-bg" placeholder="请输入每单位遗传距离（cM）的碱基个数" >
                                            <small></small>
                                        </div>
                                    </div>
