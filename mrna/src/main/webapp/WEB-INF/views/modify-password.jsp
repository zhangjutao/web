    ...
    <div class="forget modify">
        <form method="POST" action="">
            ...
            <div class="modify-u">
                <label>
                    <span>原密码:</span>
                    <input type="password" name="oldpwd" id="username" placeholder="请输入旧密码" style="line-height:36px;">
                </label>
            </div>
            <div class="modify-pwd">
                <label>
                    <span>新密码:</span>
                    <input type="password" name="password" id="new-pwd" placeholder="请输入新密码" style="line-height:36px;">
            ...
            <div class="confirm-modify-pwd">
                <label>
                    <span>确认新密码:</span>
                    <input type="password" name="pwdverify" id="confirm-new-pwd" placeholder="请确认与新密码保持一致" style="line-height:36px;">
                    <span class="tips"></span>
                </label>
            </div>
