                    ...
                    <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                        <div class="widget am-cf">
                            ...
                            <div class="widget-body  am-fr">
                                ...
                                <form class="am-form tpl-form-border-form tpl-form-border-br" modelAttribute="soybean" method="post" action="${ctxroot}/soybean/savenewsoybean">
                                    <div class="am-form-group">
                                        <label for="" class="am-u-sm-3 am-form-label"> <span class="tpl-form-line-small-title">category_name</span></label>
                                        <div class="am-u-sm-9">
                                            <input type="text" id="categoryName" name="categoryName" class="am-form-field tpl-form-no-bg" placeholder="" >
                                            <small></small>
                                        </div>
                                    </div>
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            <input type="text" id="category" name="category" class="am-form-field tpl-form-no-bg" placeholder="" >
                                            <small></small>
                                        </div>
                                    </div>
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            <textarea type="text" id="listName" name="listName" class="am-form-field tpl-form-no-bg" placeholder="" ></textarea>
                                            <small></small>
                                        </div>
                                    </div>
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            <textarea type="text" id="qtlName" name="qtlName" class="am-form-field tpl-form-no-bg" placeholder="" ></textarea>
                                            <small></small>
                                        </div>
                                    </div>
