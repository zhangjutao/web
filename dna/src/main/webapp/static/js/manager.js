            ...
            success:function (result) {
                ...
                if(count == 0){
                    ...
                    for (var i=0;i<totalDatas.length;i++){
                        ...
                        if(status == 1){
                            var str=" <tr myid="+totalDatas[i].id+"><td>"+totalDatas[i].username+"</td><td>"+totalDatas[i].email+"</td><td>"+domains+"</td><td>"+university+"</td><td>已审核</td><td><p class=\'btnAudited btnCommon\'>已审核</p></td></tr>";
                        }else{
                            var str="  <tr myid="+totalDatas[i].id+"><td>"+totalDatas[i].username+"</td><td>"+totalDatas[i].email+"</td><td>"+domains+"</td><td>"+university+"</td><td>待审核</td><td><p class=\'btnAudit btnCommon\'>待审核</p></td></tr>";
                        }
                        console.log(status);
